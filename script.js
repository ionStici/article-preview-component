...
iconBtns.forEach((btn) =>
  btn.addEventListener("click", function () {
    if (btn.classList.contains("facebook")) window.open("https://www.facebook.com/", "_blank");
    if (btn.classList.contains("twitter")) window.open("https://twitter.com/", "_blank");
    if (btn.classList.contains("pinterest")) window.open("https://www.pinterest.com/", "_blank");
  })
);
